...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sapphire " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sapphirecoin.in", "dnsseed.sapphirecoin.in"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"sapphirecoin.in", "test-dnsseed.sapphirecoin.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sapphire is probably already running."), addrBind.ToString().c_str());
        else
